<?php require basePath('/resources/view/partials/header.php') ?>
<div class="page-wrapper toggled">
<!-- sidebar-wrapper  -->
<?php require basePath('/resources/view/partials/navbar.php') ?>
<!-- Start Page Content -->
...
<?php require basePath('/resources/view/partials/footer.php') ?>
