                        ...
                        <div class="ps-1.5">
                            <div class="form-icon relative sm:block hidden">
                                ...
                                <input type="text"
                                       ...
                                       name="s" id="searchItem" placeholder="Search..." required>
                            </div>
                        </div>
                        <!-- Searchbar -->
                    </div>
                                    ...
                                    <div class="grid grid-cols-12 gap-5">
                                        <div class="col-span-12">
                                            ...
                                            <input name="title" id="title" type="text" class="form-input mt-2"
                                                   placeholder="Ads Title :" required>
                                        </div>
                                        ...
                                        <div class="md:col-span-4 col-span-12">
                                            ...
                                            <div class="form-icon relative mt-2">
                                                ...
                                                <textarea name="description" id="description" class="form-input ps-11"
                                                          placeholder="E'lon bo'yicha ta'rif..." required></textarea>
<!--                                                <input name="description" id="description" class="form-input ps-11"-->
<!--                                                       placeholder="E'lon bo'yicha ta'rif..." required>-->
                                            </div>
                                        </div>

                                        <div class="md:col-span-4 col-span-12 hidden">
                                            <div class="form-icon relative mt-2">
                                                <input name="user" value="5" type="number" class="form-input ps-11" required>
                                            </div>
                                        </div>
                                        <div class="md:col-span-4 col-span-12 hidden">
                                            <div class="form-icon relative mt-2">
                                                <input name="status" value="1" type="number" class="form-input ps-11" required>
                                            </div>
                                        </div>

                                        <div class="md:col-span-4 col-span-12 hidden">
                                            <div class="form-icon relative mt-2">
                                                <input name="branch" value="1" type="number" class="form-input ps-11" required>
                                            </div>
                                        </div>
